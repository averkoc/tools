...
> See [VirtualBox networking](https://docs.oracle.com/en/virtualization/virtualbox/7.0/user/networkingdetails.html) for a more detailed explanation about the different networking options. The table 6-1 summarizes the connectivity differencies between different networking options.
